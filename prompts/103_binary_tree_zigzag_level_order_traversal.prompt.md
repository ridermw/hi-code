---
id: binary_tree_zigzag_level_order_traversal
title: Binary Tree Zigzag Level Order Traversal
leetcodeNumber: 103
category: Breadth First Search
difficulty: Medium
source: Problems/breadth_first_search.md
---

You are generating a JSON file for a problem entry to be stored at:
app/server/data/problems/binary_tree_zigzag_level_order_traversal.json
